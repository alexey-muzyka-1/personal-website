...
type Store interface {
	...
	UserStage(ctx context.Context, telegramID int64) (Stage, error)
	// HasEvent — было ли у человека такое событие хоть раз.
	HasEvent(ctx context.Context, telegramID int64, name string) (bool, error)
